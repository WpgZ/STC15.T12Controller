...
uint8_t CODE ntcTable[51] = {72, 75, 78, 81, 84, 87, 90, 93, 97, 100, 104, 107, 110, 114, 117, 121, 124, 128, 132, 135, 139, 142, 146, 149, 153, 156, 160, 163, 167, 170, 173, 177, 180, 183, 186, 189, 192, 195, 198, 201, 204, 207, 210, 213, 215, 218, 220, 223, 225, 228, 230};
...
{		  	
	...
	if(error > PID_ERR_UBOUND){
		...
		iState += error;
	    if (iState < PID_MIN_D) iState = PID_MIN_D;
	    if (iState > PID_MAX_D) iState = PID_MAX_D;
